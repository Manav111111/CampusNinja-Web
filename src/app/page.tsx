...
export default function HomePage() {
  ...
  return (
    <div className="flex w-full flex-col bg-[var(--bg-main)] text-[var(--ink)] antialiased">
      ...
      <section className="relative w-full overflow-hidden min-h-[660px] px-[5%] pt-[32px] lg:pt-[42px] pb-[40px]">
        <div className="mx-auto w-full">
          <div className="grid items-start lg:grid-cols-[50%_50%] gap-6">
            ...
            <div className="flex flex-col items-start z-10 relative pt-0 lg:pt-[10px] max-w-[760px]">
              ...
              <div className="mb-[24px] flex items-center gap-[16px]">
                <span className="font-mono-spec text-[13px] font-[500] text-[#59616B]">
                  01
                </span>
                <span className="h-[1px] w-[42px] bg-[#B8BDC2]" />
                <span className="font-mono-spec text-[12px] font-[500] tracking-[0.16em] text-[#59616B] uppercase">
                  CODE • LEARN • GROW
                </span>
              </div>

              {/* Controlled, Elegant 2-Line Headline */}
              <h1 className="text-[clamp(52px,4.5vw,76px)] font-[700] leading-[1.05] tracking-[-0.045em] text-[#15191F]">
                Code Your Future.<br />
                Ninja Your Campus.
              </h1>

              {/* Light & Calm Subtitle */}
              <p className="mt-[24px] max-w-[590px] text-[18px] font-[400] leading-[1.55] text-[#66707B]">
                Your all-in-one platform for coding, study materials, projects, and skills to level up your career.
              </p>

              {/* Action Buttons */}
              <div className="mt-[28px] flex flex-wrap items-center gap-[20px]">
                {/* Primary CTA */}
                <button
                  type="button"
                  onClick={handleStudyHubClick}
                  className="group flex h-[54px] items-center justify-center gap-2 rounded-[17px] bg-[#151A20] px-[28px] text-[15px] font-[600] text-[#F7F7F4] transition-all hover:bg-[#000] active:scale-95 shadow-sm"
                >
                  <span>Explore Study Hub</span>
                  <ArrowUpRight className="h-[17px] w-[17px] transition-transform duration-200 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                </button>

                {/* Secondary CTA */}
                <Link
                  href="/skills"
                  className="flex h-[54px] items-center justify-center gap-2 rounded-[17px] border border-[#D2D5D5] bg-[rgba(255,255,255,0.28)] px-[28px] text-[15px] font-[600] text-[#303841] transition-all hover:bg-white active:scale-95"
                >
                  <span>Explore Skills</span>
                  <Code2 className="h-[17px] w-[17px] text-[#4a5568]" />
                </Link>
              </div>
              ...
              <div className="mt-[18px]">
                <button
                  ...
                  className="flex h-[54px] items-center gap-2 rounded-[16px] border border-dashed border-[#BFC4C7] bg-[rgba(255,255,255,0.10)] px-[22px] text-[14px] text-[#252B31] hover:bg-[rgba(255,255,255,0.25)] transition"
                >
                  <span className="text-[#717A82] font-[400]">Branch:</span>
                  <span className="font-[600] text-[#252B31]">{branchName || 'Artificial Intelligence and Data Science'}</span>
                </button>
              </div>

              {/* Subtle Monospace Coding Detail */}
              <div className="mt-[28px] flex items-center gap-[10px] font-mono-spec text-[13px] font-[400] tracking-[-0.01em]">
